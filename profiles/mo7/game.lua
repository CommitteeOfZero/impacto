...
root.WindowIconPath = "resources/mo7/icondata/icon.png";
root.CursorArrowPath = "resources/mo7/icondata/cursor_arrow.png";
root.CursorPointerPath = "resources/mo7/icondata/cursor_pointer.png";

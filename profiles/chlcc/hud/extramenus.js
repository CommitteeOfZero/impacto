...
var thumbnailXOffset = 20;
var thumbnailYOffset = 16;
var bp = root.ExtraMenus.MovieMenu.BoxPositions;

for (var i = 0; i < bp.length; i++) {
    root.ExtraMenus.MovieMenu.ThumbnailPositions.push({
        X: bp[i].X + thumbnailXOffset,
        Y: bp[i].Y + thumbnailYOffset
    });
}
...
for (var i = 1; i <= 10; i++) {
    ...
    root.ExtraMenus.MovieMenu.MoviesThumbnails.push("MovieThumbnail" + i);
    firstY += yDelta;
}
...
for (var i = 0; i < 7; i++) {
    for (var j = 0; j < 8; j++) {
        ...
        root.ExtraMenus.AlbumMenu.AlbumThumbnails.push("AlbumThumbnail" + (8 * i + j));
    }
}
...
for (var i = 0; i < 7; i++) {
    ...
    root.ExtraMenus.AlbumMenu.AlbumThumbnails.push("AlbumThumbnail" + (56 + i));
}
...
for (var i = 0; i <= 9; i++) {
    ...
    root.ExtraMenus.AlbumMenu.PageNums.push("PageNum" + i)
}
...
for (var i = 0; i <= 9; i++) {
    ...
    root.ExtraMenus.AlbumMenu.ReachablePageNums.push("ReachablePageNum" + i)
}

...
root.WindowIconPath = "resources/mo8/icondata/icon.png";
root.CursorArrowPath = "resources/mo8/icondata/cursor_arrow.png";
root.CursorPointerPath = "resources/mo8/icondata/cursor_pointer.png";
...
include(root.BasePaths.RootProfilesDir .. '/mo8/scriptvars.lua');
include(root.BasePaths.RootProfilesDir .. '/mo8/savedata.lua');
include(root.BasePaths.RootProfilesDir .. '/mo8/tipssystem.lua');
...
include(root.BasePaths.RootProfilesDir .. '/mo8/hud/datedisplay.lua');
include(root.BasePaths.RootProfilesDir .. '/mo8/hud/titlemenu.lua');
include(root.BasePaths.RootProfilesDir .. '/mo8/hud/systemmenu.lua');
include(root.BasePaths.RootProfilesDir .. '/mo8/hud/backlogmenu.lua');
include(root.BasePaths.RootProfilesDir .. '/mo8/hud/optionsmenu.lua');
include(root.BasePaths.RootProfilesDir .. '/mo8/hud/savemenu.lua');
include(root.BasePaths.RootProfilesDir .. '/mo8/hud/sysmesboxdisplay.lua');
include(root.BasePaths.RootProfilesDir .. '/mo8/hud/selectiondisplay.lua');
include(root.BasePaths.RootProfilesDir .. '/mo8/hud/tipsmenu.lua');
include(root.BasePaths.RootProfilesDir .. '/mo8/hud/tipsnotification.lua');

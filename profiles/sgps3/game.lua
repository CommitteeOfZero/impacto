...
root.WindowIconPath = "resources/sgps3/icondata/icon.png";
root.CursorArrowPath = "resources/sgps3/icondata/cursor_arrow.png";
root.CursorPointerPath = "resources/sgps3/icondata/cursor_pointer.png";

...
include(root.BasePaths.RootProfilesDir .. '/darling/scriptvars.lua');
include(root.BasePaths.RootProfilesDir .. '/darling/savedata.lua');
include(root.BasePaths.RootProfilesDir .. '/darling/tipssystem.lua');
...
include(root.BasePaths.RootProfilesDir .. '/darling/hud/saveicon.lua');
include(root.BasePaths.RootProfilesDir .. '/darling/hud/loadingdisplay.lua');
include(root.BasePaths.RootProfilesDir .. '/darling/hud/datedisplay.lua');
include(root.BasePaths.RootProfilesDir .. '/darling/hud/titlemenu.lua');
include(root.BasePaths.RootProfilesDir .. '/darling/hud/backlogmenu.lua');
--include(root.BasePaths.RootProfilesDir .. '/darling/hud/systemmenu.lua');
include(root.BasePaths.RootProfilesDir .. '/darling/hud/sysmesboxdisplay.lua');
include(root.BasePaths.RootProfilesDir .. '/darling/hud/selectiondisplay.lua');
include(root.BasePaths.RootProfilesDir .. '/darling/hud/tipsmenu.lua');
include(root.BasePaths.RootProfilesDir .. '/darling/hud/tipsnotification.lua');
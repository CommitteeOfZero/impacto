...
sv.SW_MAP_ZOOM = 6362;
sv.SW_MAP_POS_X = 6363;
sv.SW_MAP_POS_Y = 6364;
sv.SW_MAP_DST_POS_X = 6365;
sv.SW_MAP_DST_POS_Y = 6366;
sv.SW_MAP_SELECTED_POOL_INDEX = 6367;
sv.SW_MAP_SELECTED_POOL_ID = 6368;
sv.SW_MAP_SELECTED_POOL_TYPE = 6381;
sv.SW_MAP_PHOTO_SELECT_STATE = 6500;
sv.SW_MAP_RENDER_ALPHA_1 = 6369;
sv.SW_MAP_RENDER_ALPHA_2 = 6370;
sv.SW_MAP_RENDER_ALPHA_3 = 6371;
sv.SW_DELUSION_STATE = 6412;
sv.SW_YESNO_SELECTED = 6432;
sv.SW_YESNO_CT = 6433;
sv.SW_YESNO_TARGET_INDEX = 6434;
...
sv.SF_MAPENABLE = 2800;
sv.SF_MAP_RENDER_UNK1 = 2801;
sv.SF_MAP_RENDER_UNK2 = 2802;
sv.SF_MAP_RENDER_UNK3 = 2803;
sv.SF_MAP_RENDER_UNK4 = 2804;
sv.SF_MAP_NO_CLAMP = 2805;
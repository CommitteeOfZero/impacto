...
glm::vec2 ListStartingPosition;
glm::vec2 ListPadding;
glm::vec2 OptionGroupItemsOffset;
glm::vec2 OptionGroupSliderOffset;

Sprite TextPageLabel;

int TextSpeedOptionsNum;
Sprite TextSpeedOptionsLabel;
Sprite TextSpeedOptionsLabelH;
Sprite TextSpeedOptionsSprites[TextSpeedOptionsNumMax];
Sprite TextSpeedOptionsHSprites[TextSpeedOptionsNumMax];

int AutoModeOptionsNum;
Sprite AutoModeOptionsLabel;
Sprite AutoModeOptionsLabelH;
Sprite AutoModeOptionsSprites[AutoModeOptionsNumMax];
Sprite AutoModeOptionsHSprites[AutoModeOptionsNumMax];

int SkipModeOptionsNum;
Sprite SkipModeOptionsLabel;
Sprite SkipModeOptionsLabelH;
Sprite SkipModeOptionsSprites[SkipModeOptionsNumMax];
Sprite SkipModeOptionsHSprites[SkipModeOptionsNumMax];

int SoundModeOptionsNum;
Sprite SoundPageLabel;
Sprite SoundModeOptionsSprites[SoundOptionsNumMax];
Sprite SoundModeOptionsHSprites[SoundOptionsNumMax];

Sprite VoiceSyncOptionsLabel;
Sprite VoiceSyncOptionsLabelH;

Sprite VoiceSkipOptionsLabel;
Sprite VoiceSkipOptionsLabelH;

Sprite VoiceHighlightOptionsLabel;
Sprite VoiceHighlightOptionsLabelH;

Sprite BgmVolumeLabel;
Sprite BgmVolumeLabelH;
Sprite VoiceVolumeLabel;
Sprite VoiceVolumeLabelH;
Sprite SeVolumeLabel;
Sprite SeVolumeLabelH;
Sprite SystemSeVolumeLabel;
Sprite SystemSeVolumeLabelH;
Sprite CharacterVoiceVolumeLabel;
Sprite CharacterVoiceVolumeLabelH;

Sprite OtherPageLabel;

Sprite QuickSaveOptionsLabel;
Sprite QuickSaveOptionsLabelH;
int QuickSaveOptionsNum;
Sprite QuickSaveOptionsSprites[QuickSaveOptionsNumMax];
Sprite QuickSaveOptionsHSprites[QuickSaveOptionsNumMax];

...
void Configure() {
  ...
  KB_PAD1A = GetMemberUintVector("KB_PAD1A");
  KB_PAD1B = GetMemberUintVector("KB_PAD1B");
  KB_PAD1X = GetMemberUintVector("KB_PAD1X");
  KB_PAD1Y = GetMemberUintVector("KB_PAD1Y");
  KB_PAD1SELECT = GetMemberUintVector("KB_PAD1SELECT");
  KB_PAD1START = GetMemberUintVector("KB_PAD1START");
  KB_PAD1UP = GetMemberUintVector("KB_PAD1UP");
  KB_PAD1DOWN = GetMemberUintVector("KB_PAD1DOWN");
  KB_PAD1LEFT = GetMemberUintVector("KB_PAD1LEFT");
  KB_PAD1RIGHT = GetMemberUintVector("KB_PAD1RIGHT");
  KB_PAD1L1 = GetMemberUintVector("KB_PAD1L1");
  KB_PAD1L2 = GetMemberUintVector("KB_PAD1L2");
  KB_PAD1L3 = GetMemberUintVector("KB_PAD1L3");
  KB_PAD1R1 = GetMemberUintVector("KB_PAD1R1");
  KB_PAD1R2 = GetMemberUintVector("KB_PAD1R2");
  KB_PAD1R3 = GetMemberUintVector("KB_PAD1R3");
  KB_PAD1UP_RS = GetMemberUintVector("KB_PAD1UP_RS");
  KB_PAD1DOWN_RS = GetMemberUintVector("KB_PAD1DOWN_RS");

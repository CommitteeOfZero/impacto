...
V(SW_BGEFF1_SIZEX_OFS)
V(SW_BGEFF1_SIZEY_OFS)
V(SW_BGEFF1_LX_OFS)
V(SW_BGEFF1_LY_OFS)
V(SW_MAINTHDP)
V(SW_RESTARTMASK)
...
V(SW_RENDERTARGET_PRI0)  // CHLCC
V(SW_RENDERTARGET_BUF0)  // CHLCC
V(SW_RENDERTARGET_PRI1)  // CHLCC
V(SW_RENDERTARGET_BUF1)  // CHLCC

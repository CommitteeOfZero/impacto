...
InstructionProc static OpcodeTableSystem_RNE[256] = {
    InstEnd,                  // 00 00
...
InstructionProc static OpcodeTableGraph_RNE[256] = {
...
InstructionProc static OpcodeTableUser1_RNE[256] = {
    InstMSinit,            // 10 00
    InstBGload,            // 10 01
    InstBGswap,            // 10 02
...
InstructionProc static OpcodeTableGraph3D_RNE[256] = {
    InstDummy,               // 02 00
    InstCHAload3D,           // 02 01

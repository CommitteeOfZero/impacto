...
InstructionProc inline constexpr OpcodeTableSystem_LCCSwitch[256] = {
    InstEnd,                  // 00 00
    InstCreateThreadNew,      // 00 01
    InstKillThread,           // 00 02
    InstReset,                // 00 03
    InstScriptLoadNew,        // 00 04
    InstWait,                 // 00 05
    InstHalt,                 // 00 06
    InstJump,                 // 00 07
    InstJumpTable,            // 00 08
    ...
    InstSetFlagNew,           // 00 12
    InstResetFlagNew,         // 00 13
    InstCopyFlag,             // 00 14
    InstKeyOnJump,            // 00 15
    InstKeyWait,              // 00 16
    ...
    InstDummy,                // 00 59
    InstDummy,                // 00 5A
    InstSaveIconState,        // 00 5B
    InstFlagOffReturn,        // 00 5C
    InstDummy,                // 00 5D
    InstCPUBoostMode,         // 00 5E
...
InstructionProc inline constexpr OpcodeTableUser1_LCCSwitch[256] = {
    ...
    InstCHAmove,           // 10 0D // dummy for switch cclcc
    InstBGloadEx,          // 10 0E
    InstDummy,             // 10 0F
    InstBGrelease,         // 10 10
...
InstructionProc inline constexpr OpcodeTableTitleOnly_LCCSwitch[256] = {
    InstDummy,                // 20 00
    InstDummy,                // 20 01
    InstDummy,                // 20 02
    InstDummy,                // 20 03
    ...
    InstDummy,                // 20 0E
    InstDummy,                // 20 0F
    InstUnk2010CCLCC,         // 20 10
    InstUnk2011CCLCC,         // 20 11
    InstUnk2012CCLCC,         // 20 12
    InstDummy,                // 20 13
    InstDummy,                // 20 14
    InstDummy,                // 20 15
    InstDummy,                // 20 16

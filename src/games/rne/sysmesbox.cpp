...
//      float buttonYesSpriteWidth = ButtonYWidthBase +
//      labelButtonSpriteOffsetX; if (buttonYesSpriteWidth > ButtonWidth)
...
//                               glm::vec2(BoxDisplayX, BoxBottomY - 3.0f),
//                               col);
//      }
//
//      if (BoxProgressCount > TextStartCount) {
...
//          Renderer2D::DrawSprite(
//              TextDecoration,
//              glm::vec2(BoxDisplayX, BoxBottomY -
//              TextDecorationBottomYOffset), texCol);
//        }
//        Renderer2D::DrawSprite(MessageLabel,
//                               glm::vec2(BoxDisplayX, BoxTopY + 3.0f),
//                               texCol);
//
//        if (ChoiceCount == 2) {
//          Renderer2D::DrawSprite(
...
//            Messages[i][lineLen].DestRect.Y = textBeginY + (i *
//            TextLineHeight);
//          }
//          Renderer2D::DrawProcessedText(
//              Messages[i], lineLen, Profile::Dialogue::DialogueFont,
//              texCol.a);
//        }
//      }
//

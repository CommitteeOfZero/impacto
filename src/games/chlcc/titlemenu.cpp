...
//  Renderer2D::DrawSprite(SeiraUnderSprite, glm::vec2(SeiraUnderX,
//  SeiraUnderY)); Renderer2D::DrawSprite(SeiraSprite, glm::vec2(SeiraX,
//  SeiraY)); Renderer2D::DrawSprite(CHLogoSprite, glm::vec2(CHLogoX, CHLogoY));

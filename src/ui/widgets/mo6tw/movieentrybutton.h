...
class MovieEntryButton : public Widgets::Button {
 public:
  MovieEntryButton(int id, Sprite const& norm, Sprite const& disabled,
  ...
  MovieEntryButton(int id, Sprite const& normTopPart,
